...
export type LoginMutation = (
  ...
  & { login: (
    ...
    & { errors?: Maybe<Array<(
      ...
      { __typename?: 'tokenAndId' }
      & Pick<TokenAndId, 'accessToken' | 'userId' | 'userRoleCode'>
    )> }
  ) }
);
...
export type UpdateSeetingsUserMutation = (
  { __typename?: 'Mutation' }
  & { updateSeetingsUser: (
    { __typename?: 'UserResponse' }
    & { errors?: Maybe<Array<(
      { __typename?: 'ErrorFieldHandler' }
      & Pick<ErrorFieldHandler, 'field' | 'message' | 'method'>
    )>>, user?: Maybe<(
      { __typename?: 'User' }
      & Pick<User, 'id' | 'name' | 'email'>
      & { role: (
...
export type GetAllRolesQuery = (
  ...
  & { getAllRoles: (
    ...
    & { errors?: Maybe<Array<(
      { __typename?: 'ErrorFieldHandler' }
      & Pick<ErrorFieldHandler, 'method' | 'message' | 'field'>
    )>>, roles?: Maybe<Array<(
      { __typename?: 'Role' }
      & Pick<Role, 'id' | 'name' | 'code' | 'wage'>
    )>> }
  ) }
);
...
export type GetAppointmentsByItemQuery = (
  { __typename?: 'Query' }
...
export type GetItensBacklogQuery = (
  { __typename?: 'Query' }
  & { getItensBacklog: (
    { __typename?: 'ItensResponse' }
    & { errors?: Maybe<Array<(
      ...
      { __typename?: 'Item' }
      & Pick<Item, 'id' | 'summary' | 'type' | 'priority' | 'status' | 'description' | 'updatedAt'>
      & { responsible: (
        { __typename?: 'User' }
        & Pick<User, 'id' | 'name'>
      ), reporter: (
        ...
        { __typename?: 'Sprint' }
        & Pick<Sprint, 'code' | 'createdAt' | 'length' | 'final'>
        & { project: (
          { __typename?: 'Project' }
          & Pick<Project, 'name'>
        ) }
...
export type GetItensRelatedToUserByPeriodQuery = (
  { __typename?: 'Query' }
  & { getItensRelatedToUserByPeriod: (
    { __typename?: 'ItensResponse' }
    & { errors?: Maybe<Array<(
      { __typename?: 'ErrorFieldHandler' }
      & Pick<ErrorFieldHandler, 'message'>
    )>>, itens?: Maybe<Array<(
      { __typename?: 'Item' }
      & Pick<Item, 'id' | 'summary' | 'description' | 'status' | 'type' | 'priority' | 'responsible_id' | 'reporter_id' | 'approver_id'>
    )>> }
  ) }
);
...
export type GetProjectByIdQuery = (
  ...
  & { getProjectById: (
    ...
    & { errors?: Maybe<Array<(
      ...
      & { sprints: Array<(
        { __typename?: 'Sprint' }
        & Pick<Sprint, 'id' | 'code' | 'final' | 'length' | 'description' | 'active'>
        & { itens: Array<(
          { __typename?: 'Item' }
          & Pick<Item, 'id' | 'summary' | 'description' | 'status' | 'priority' | 'type'>
        )> }
      )> }
    )> }
  ) }
...
export type GetProjectsQuery = (
  ...
  & { getProjects?: Maybe<Array<(
    { __typename?: 'Project' }
    & Pick<Project, 'id' | 'name' | 'createdAt' | 'description'>
  )>> }
);
...
export type GetUserByIdQuery = (
  ...
  & { getUserById: (
    ...
    & { errors?: Maybe<Array<(
      { __typename?: 'ErrorFieldHandler' }
      & Pick<ErrorFieldHandler, 'message' | 'method'>
    )>>, user?: Maybe<(
      { __typename?: 'User' }
      & Pick<User, 'id' | 'name' | 'email'>
      & { itenReporter: Array<(
        { __typename?: 'Item' }
        & Pick<Item, 'id' | 'createdAt' | 'updatedAt' | 'status'>
      )>, itenApprover: Array<(
        { __typename?: 'Item' }
        & Pick<Item, 'id' | 'createdAt' | 'updatedAt' | 'status'>
...
export type GetUserSettingsQuery = (
  ...
  & { getUserSettings: (
    ...
    & { errors?: Maybe<Array<(
      ...
      { __typename?: 'User' }
      & Pick<User, 'id' | 'name' | 'email' | 'password' | 'picure'>
      & { role: (
        { __typename?: 'Role' }
        & Pick<Role, 'id' | 'name' | 'code'>
      ) }
    )> }
  ) }
);
...
export function useUpdateSeetingsUserMutation() {
  return Urql.useMutation<UpdateSeetingsUserMutation, UpdateSeetingsUserMutationVariables>(UpdateSeetingsUserDocument);
};
...
export function useGetAllRolesQuery(options: Omit<Urql.UseQueryArgs<GetAllRolesQueryVariables>, 'query'> = {}) {
...
export function useGetAppointmentsByItemQuery(options: Omit<Urql.UseQueryArgs<GetAppointmentsByItemQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<GetAppointmentsByItemQuery>({ query: GetAppointmentsByItemDocument, ...options });
};
...
export function useGetItensBacklogQuery(options: Omit<Urql.UseQueryArgs<GetItensBacklogQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<GetItensBacklogQuery>({ query: GetItensBacklogDocument, ...options });
};
export const GetItensRelatedToUserByPeriodDocument = gql`
    query GetItensRelatedToUserByPeriod($limit: Float, $userId: String!, $createdAfter: DateTime, $createdLater: DateTime) {
  getItensRelatedToUserByPeriod(
    limit: $limit
    userId: $userId
...
export function useGetItensRelatedToUserByPeriodQuery(options: Omit<Urql.UseQueryArgs<GetItensRelatedToUserByPeriodQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<GetItensRelatedToUserByPeriodQuery>({ query: GetItensRelatedToUserByPeriodDocument, ...options });
};
